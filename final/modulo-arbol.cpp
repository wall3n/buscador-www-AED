...
void ArbolPalabras::NodoTrie::ponEnLista(Pagina * pag){
    std::list<Pagina *>::iterator it = this->lista.begin();
...
std::list<Pagina *> ArbolPalabras::NodoTrie::getLista(){
    return this->lista;
}
...
void ArbolPalabras::insertar(std::string pal, Pagina * pagina){
...
std::list<Pagina *> ArbolPalabras::buscar(std::string pal){
    NodoTrie * pos = this->cabecera;
    int i = 0;
